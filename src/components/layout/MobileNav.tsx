...
export function MobileNav({ className }: MobileNavProps) {
  ...
  return (
    // Room for this bar is reserved by the page's own bottom padding
    // (.pb-nav), not by a spacer here: a fixed bar and a spacer are two
    // separate claims on the same space, and they had drifted apart into
    // about eighty pixels of dead screen.
    <nav
      className={cn(
