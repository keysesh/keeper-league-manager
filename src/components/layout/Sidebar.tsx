...
export function Sidebar({ isAdmin = false }: SidebarProps) {
  ...
  return (
    <aside
      className="hidden lg:flex lg:flex-col lg:w-56 lg:border-r lg:border-white/[0.06] bg-[#0F0B1A]/90 backdrop-blur-xl min-h-[calc(100vh-4rem)]"
    ...
    >
          ...
          return (
            ...
            >
              <span
                ...
                ${isActive
                  ? "bg-violet-500/20 text-violet-400 shadow-[0_0_20px_rgba(139,92,246,0.2)]"
      ...
      <div className="mx-5 mb-6">
        <div className="p-5 rounded-2xl bg-gradient-to-br from-violet-500/10 via-violet-600/5 to-transparent border border-violet-500/10 backdrop-blur-sm">
