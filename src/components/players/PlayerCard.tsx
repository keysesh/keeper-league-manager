...
export function PlayerCard({
  ...
  if (compact) {
    return (
      <div
        onClick={onClick}
        className={`flex items-center gap-3 p-2 rounded-lg bg-gray-800 hover:bg-gray-750 transition-colors ${onClick ? "cursor-pointer" : ""} ${className}`}
      >
  ...
  return (
    <div
      onClick={onClick}
      className={`p-4 rounded-lg bg-gray-800 border border-gray-700 hover:border-gray-600 transition-colors ${onClick ? "cursor-pointer" : ""} ${className}`}
    >
      ...
      {keeperInfo && (
        <div className="mt-4 pt-3 border-t border-gray-700">
          <div className="flex justify-between text-sm">
            <span className="text-gray-400">Keeper Cost</span>
            <span className="text-white font-medium">Round {keeperInfo.cost}</span>
          </div>
          <div className="flex justify-between text-sm mt-1">
            <span className="text-gray-400">Years Kept</span>
