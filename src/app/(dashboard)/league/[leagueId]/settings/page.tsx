    ...
    <div className="max-w-4xl mx-auto p-4 md:p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
        <div>
          ...
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-md bg-[#222222] border border-[#333333] flex items-center justify-center">
        ...
        {data.isCommissioner && hasChanges && (
          <button
            onClick={handleSave}
            disabled={saving}
            className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-md transition-colors disabled:opacity-50"
          >
      ...
      <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-md p-5">
        <div className="flex items-center gap-3">
          <div className="flex items-center justify-center w-10 h-10 rounded-md bg-[#222222] border border-[#333333]">
          ...
          {data.isCommissioner && (
            <span className="ml-auto px-3 py-1 bg-blue-500/20 text-blue-400 text-xs font-medium rounded-md border border-blue-500/30">
              You
            </span>
          )}
        </div>
      ...
      <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-md overflow-hidden">
        <div className="px-6 py-4 border-b border-[#2a2a2a] bg-[#222222]">
        ...
        {formData.maxFranchiseTags + formData.maxRegularKeepers > formData.maxKeepers && (
          <div className="mx-6 mb-6 flex items-center gap-2 px-4 py-3 bg-red-500/10 border border-red-500/30 rounded-md text-red-400 text-sm">
      ...
      {data.isCommissioner && (
        <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-md overflow-hidden">
          ...
          <div className="p-6 space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 bg-[#222222] rounded-md border border-[#333333]">
              <div>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2.5 bg-red-500/20 hover:bg-red-500/30 border border-red-500/30 text-red-400 rounded-md text-sm font-medium transition-colors disabled:opacity-50"
                >
                  <Lock size={16} />
                  Lock
                </button>
                <button
                  ...
                  disabled={lockingKeepers}
                  className="inline-flex items-center gap-2 px-4 py-2.5 bg-emerald-500/20 hover:bg-emerald-500/30 border border-emerald-500/30 text-emerald-400 rounded-md text-sm font-medium transition-colors disabled:opacity-50"
                >
                  <Unlock size={16} />
                  Unlock
                </button>
            ...
            <Link
              ...
              className="flex items-center justify-between p-4 bg-[#222222] rounded-md border border-[#333333] hover:border-[#444444] hover:bg-[#2a2a2a] transition-all group"
            >
              <div>
                <p className="text-white font-medium group-hover:text-blue-400 transition-colors">Advanced Tools</p>
    ...
    <div className={`space-y-2 ${disabled ? "opacity-60" : ""}`}>
      ...
      <div className="flex items-center gap-3">
        <input
          ...
          max={max}
          disabled={disabled}
          className="w-24 px-3 py-2 bg-[#222222] border border-[#333333] rounded-md text-white text-center font-mono focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 disabled:cursor-not-allowed transition-colors"
        />
...
function RuleSummaryItem({
  ...
  return (
    <div className="flex items-start gap-3 p-3 rounded-md bg-[#222222] border border-[#333333]">
