...
// ============================================
// EDITORIAL THEME — the five league screens
// (design handoff Aug 2026). These values are
// final per the handoff; the `.editorial` class
// in globals.css carries the base surface/type.
// ============================================
...
export const editorial = {
  surface: {
    app: "#0b120f",
    card: "#131b17",
    chip: "#1c2621", // avatar placeholder / chip
  },
  border: {
    hairline: "rgba(214,255,232,.10)",
    strong: "rgba(214,255,232,.16)",
    fill: "rgba(214,255,232,.05)",
  },
  text: {
    primary: "#eee7da",
    body: "#ded7c8",
    secondary: "#a8ac9d",
    // 4.5:1 floor at 11px — nothing dimmer than this
    tertiary: "#93a08f",
  },
  accent: {
    brick: "#a8401f", // fills; pair with onAccent for 4.5:1
    text: "#d4674a", // accent text / active tab on dark
    hover: "#bd4a26",
    active: "#8f3517",
    wash: "rgba(199,80,47,.07)",
  },
  semantic: {
    amber: "#c9922f", // deadlines, franchise tags
    onAccent: "#fdf6e8",
  },
  position: {
    QB: "#c2665a",
...
/** Position token colour for the editorial screens (falls back to tertiary). */
export function editorialPositionColor(position: string | null | undefined): string {
  return (position && editorial.position[position]) || editorial.text.tertiary;
}
